...
val generateS10Operations = tasks.register<Exec>("generateS10Operations") {
    ...
    inputs.file(rootProject.file("tools/apply_s54a_beta48_history_anchor.py"))
    inputs.file(rootProject.file("tools/apply_s54_beta48_owner_10_fixes.py"))
    inputs.file(rootProject.file("tools/apply_s55_beta48_log_summary_ui.py"))
    inputs.file(rootProject.file("tools/apply_s56_beta49_android_field_fixes.py"))
...
// Beta49: live Service resource availability, daily User Pick/User Pack uniqueness, both-shift Pack mappings, no connected-users UI, truthful log accounting, and canonical Sheet replication recovery.
