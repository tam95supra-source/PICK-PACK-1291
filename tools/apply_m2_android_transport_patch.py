...
if marker in s:
    print("M2 Android transport already applied; composing S19/S20/S21/S22/S23/S24 runtime fixes.")
...
runpy.run_path(str(ROOT / "tools/apply_s23_pda_import_ui.py"), run_name="__main__")
runpy.run_path(str(ROOT / "tools/apply_s24_fcm_logout_patch.py"), run_name="__main__")
print(f"Applied M2 dynamic Service transport + S19/S20/S21/S22/S23/S24 runtime patches: {path}")
