...
const ALLOWED=new Set(["staff_upsert","staff_delete","account_upsert","account_status","account_delete","change_email","change_password","staff_import","account_login","account_logout","settings_change"]);
